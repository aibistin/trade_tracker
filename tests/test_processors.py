...
class TestCSVProcessing(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.processor = CSVProcessor(self.test_input_dir, self.test_output_dir, self.test_processed_dir)
    ...
    def test_extract_quantity(self):
        ...
        self.assertEqual(CSVProcessor.extract_quantity("50 Shares (All or None)"), 50)
    ...
    def test_convert_trade_date(self):
        ...
        self.assertEqual(CSVProcessor.convert_trade_date("08/31/2024", "%m/%d/%Y"), "2024-08-31")
        # Add more test cases
